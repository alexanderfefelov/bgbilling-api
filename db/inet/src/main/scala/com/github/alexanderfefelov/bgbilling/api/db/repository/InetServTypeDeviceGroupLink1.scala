...
object InetServTypeDeviceGroupLink1 extends SQLSyntaxSupport[InetServTypeDeviceGroupLink1] with ApiDbConfig {

  override val tableName = s"inet_serv_type_device_group_link_${bgBillingModuleId("inet")}"
