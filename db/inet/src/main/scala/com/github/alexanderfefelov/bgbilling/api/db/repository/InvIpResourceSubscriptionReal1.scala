...
object InvIpResourceSubscriptionReal1 extends SQLSyntaxSupport[InvIpResourceSubscriptionReal1] {

  override val tableName = "inv_ip_resource_subscription_real_1"
