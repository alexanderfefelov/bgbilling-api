...
object InvDevicePortSubscription1 extends SQLSyntaxSupport[InvDevicePortSubscription1] with ApiDbConfig {

  override val tableName = s"inv_device_port_subscription_${bgBillingModuleId("inet")}"
