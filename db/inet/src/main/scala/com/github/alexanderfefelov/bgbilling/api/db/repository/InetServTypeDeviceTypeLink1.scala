...
object InetServTypeDeviceTypeLink1 extends SQLSyntaxSupport[InetServTypeDeviceTypeLink1] with ApiDbConfig {

  override val tableName = s"inet_serv_type_device_type_link_${bgBillingModuleId("inet")}"
