...
object InetAccountingPeriod1 extends SQLSyntaxSupport[InetAccountingPeriod1] with ApiDbConfig {

  override val tableName = s"inet_accounting_period_${bgBillingModuleId("inet")}"
