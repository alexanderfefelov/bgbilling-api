...
object InetTariffTrafficRange1 extends SQLSyntaxSupport[InetTariffTrafficRange1] with ApiDbConfig {

  override val tableName = s"inet_tariff_traffic_range_${bgBillingModuleId("inet")}"
