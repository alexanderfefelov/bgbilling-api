...
object InetSessionDetail1 extends SQLSyntaxSupport[InetSessionDetail1] with ApiDbConfig {

  override val tableName = s"inet_session_detail_${bgBillingModuleId("inet")}"
